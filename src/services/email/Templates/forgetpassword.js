...
export const forgetpassword = (otp, usertype) => {
  return `<!DOCTYPE html>
    <html lang="en">
      ...
      <center style="max-width: 560px; margin: 0 auto">
        ...
        <div class="center">
          <div style="background-color: #ffffff; padding: 1px 0; box-shadow: -1px 4px -6px rgba(0, 0, 0, 0);border-radius: 10px;padding-bottom: 20px">
            ...
            <hr class="emailline">
            <p class="paragraph">In order to reset your ${usertype === 'S' ? 'CovidCheX' : 'CovidChecker'} password, you need to enter this OTP.</p>
            <a>
              <p class="otp">${otp}</p>
            </a>
